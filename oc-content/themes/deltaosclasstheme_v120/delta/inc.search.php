      ...
      <form action="<?php echo osc_base_url(true); ?>" method="GET" class="nocsrf" id="search-form" >
        ...
        <div class="w2">
          <div id="location-picker" class="loc-picker ctr-<?php echo (del_count_countries() == 1 ? 'one' : 'more'); ?>">
            <div class="mini-box">
              <input type="text" id="term" class="term" placeholder="<?php _e('Everywhere', 'delta'); ?>" value="<?php echo del_get_term(Params::getParam('term'), Params::getParam('sCountry'), Params::getParam('sRegion'), Params::getParam('sCity')); ?>" autocomplete="off" />
