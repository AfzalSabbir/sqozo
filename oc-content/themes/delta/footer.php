  ...
  <div class="inside">
    <div class="pub-box-line">
      <div class="pub-box">
        <div class="wrap">
          <div class="info">
            <h3><?php _e('No. 1 online classifieds platform', 'delta'); ?></h3>
            <div class="desc"><?php _e('Our aim is to empower every person in the country to independently connect with buyers and sellers online. We care about you and the transactions that bring you closer to your dreams.', 'delta'); ?></div>
          </div>
...
<style>
.loc-picker .region-tab:empty:after {content:"<?php echo osc_esc_html(__('Select country first to get list of regions', 'delta')); ?>";}
.loc-picker .city-tab:empty:after {content:"<?php echo osc_esc_html(__('Select region first to get list of regions', 'delta')); ?>";}
