...
<?php
  ...
  if(!$edit) {
    ...
    $prepare['s_phone'] = del_get_session('sPhone') <> '' ? del_get_session('sPhone') : osc_user_phone();
    ...
    $prepare['s_phone'] = del_get_session('sPhone') <> '' ? del_get_session('sPhone') : @$item_extra['s_phone'];
          ...
          <?php if(osc_price_enabled_at_items()) { ?>
            ...
            <div class="price-wrap">
              <div class="inside">
                ...
                <div class="selection">
                  <a href="#" data-price="0" <?php if($price_type == 'FREE') { ?>class="active"<?php } ?> title="<?php osc_esc_html(__('Item is offered for free', 'delta')); ?>"><span class="isTablet isDesktop"><?php _e('Free', 'delta'); ?></span><span class="isMobile"><?php _e('Item for free', 'delta'); ?></span></a>
                  <a href="#" data-price="" <?php if($price_type == 'CHECK') { ?>class="active"<?php } ?> title="<?php osc_esc_html(__('Based on agreement with seller', 'delta')); ?>"><span class="isTablet isDesktop"><?php _e('Deal', 'delta'); ?></span><span class="isMobile"><?php _e('Check with seller', 'delta'); ?></span></a>
                </div>
              </div>
            </div>
          <?php } ?>
