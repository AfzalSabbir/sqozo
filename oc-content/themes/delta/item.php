      ...
      <?php if(osc_item_user_id() > 0) { ?>
        <div class="wbox" id="about">
          ...
          <div class="rb">
            ...
            <?php if($item_user['s_phone_land'] <> '') { ?>
              <div class="extra"><?php echo $item_user['s_phone_land']; ?></div>
            <?php } ?>

            <?php if($item_user['s_phone_mobile'] <> '') { ?>
              <div class="extra"><?php echo $item_user['s_phone_mobile']; ?></div>
            <?php } ?>            
